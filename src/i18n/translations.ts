...
const en = {
  ...
  'dashboard.noOverdue': 'NO OVERDUE',
  ...
  'properties.deleteMessage': 'Are you sure?',
  'properties.deleteConfirm': 'Delete',
  'properties.deleteCancel': 'Cancel',
  ...
  'tenants.deleteMessage': 'Are you sure?',
  'tenants.deleteConfirm': 'Delete',
  'tenants.deleteCancel': 'Cancel',
  ...
  'createTenant.email': 'Email',
  'createTenant.emailPlaceholder': 'email@example.com',
  'createTenant.id': 'ID',
  ...
  'contractPayments.collect': 'Collect',
  'contractPayments.startDate': 'Start Date',
  'contractPayments.endDate': 'End Date',
  'contractPayments.property': 'Property',
  'contractPayments.tenant': 'Tenant',
...
const ar: typeof en = {
  ...
  'dashboard.noOverdue': 'لا تأخير',
  'dashboard.allClear': 'كل شيء بخير',
  ...
  'properties.deleteTitle': 'حذف العقار',
  'properties.deleteMessage': 'هل أنت متأكد؟',
  'properties.deleteConfirm': 'حذف',
  'properties.deleteCancel': 'إلغاء',
  ...
  'tenants.deleteTitle': 'حذف المستأجر',
  'tenants.deleteMessage': 'هل أنت متأكد؟',
  'tenants.deleteConfirm': 'حذف',
  'tenants.deleteCancel': 'إلغاء',
  ...
  'createTenant.phonePlaceholder': '01xxxxxxxxx',
  'createTenant.email': 'البريد الإلكتروني',
  'createTenant.emailPlaceholder': 'email@example.com',
  ...
  'contractPayments.collect': 'تحصيل',
  'contractPayments.startDate': 'تاريخ البداية',
  'contractPayments.endDate': 'تاريخ النهاية',
  'contractPayments.property': 'العقار',
  'contractPayments.tenant': 'المستأجر',
